...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public UserDetailsService userDetailsService() {
        ...
        InMemoryUserDetailsManager imusersDetails = new InMemoryUserDetailsManager();
        imusersDetails.createUser(user);
        imusersDetails.createUser(user2);

		return imusersDetails;
	}
}